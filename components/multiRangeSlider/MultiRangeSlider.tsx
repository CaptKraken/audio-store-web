...
/**
 * modified from https://codesandbox.io/s/b9l0g
 * @param {Object} MultiRangeSliderProps
 * @returns FC<MultiRangeSliderProps>
 */
  ...
  return (
    <div className={"w-full my-4 relative"}>
      ...
      <div className={styles["slider"]}>
        ...
        <div
          ref={range}
          className={`${styles["slider__range"]} bg-green-400`}
        ></div>
